...
import { SystemAdministrator } from 'src/app/model/system-administrator';
import { User } from 'src/app/model/user.model';
import { AuthService } from 'src/app/service/auth.service';
import { SystemAdministratorService } from 'src/app/service/system-administrator.service';
...
export class CreateSystemAdminComponent implements OnInit {
  ...
  public administrator: SystemAdministrator = new SystemAdministrator();
  ...
  constructor(private toastr: ToastrService,private systemAdministratorService: SystemAdministratorService, private route: ActivatedRoute,
  ...
  onSubmit() {
    ...
    this.systemAdministratorService.createSystemAdmin(this.administrator).subscribe(
